...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2019 at 01:46 PM
...
(5, 'amin', 'Malang', 'Laki-laki', '08989989', 'moh.aminfathullah@gmail.com', 'amin', '30ae43ad1aa0a416699051b73a3dfcf6', '', 1, NULL, '2019-12-09 08:23:45', NULL),
(6, 'audria', 'Batu', 'Perempuan', '0812334462349', 'audria123@gmail.com', 'audria', '285e39530054c457c9e0e598c95ce6fa', '', 1, NULL, '2019-12-09 16:25:00', NULL);
...
(25, '2019-12-09 09:02:37', 'belum di bayar', 5),
(26, '2019-12-09 10:14:41', 'belum di bayar', 5),
(27, '2019-12-09 10:21:45', 'belum di bayar', 5),
(28, '2019-12-09 10:46:06', 'belum di bayar', 5),
(29, '2019-12-09 10:46:37', 'sudah di bayar', 5),
(30, '2019-12-09 10:46:56', 'belum di bayar', 5),
(31, '2019-12-09 13:39:08', 'sudah di kirim', 5),
(32, '2019-12-09 14:50:11', 'belum di bayar', 3),
(33, '2019-12-09 16:18:31', 'sudah di bayar', 5),
(34, '2019-12-09 16:34:48', 'sudah di kirim', 6),
(35, '2019-12-09 17:37:46', 'belum di bayar', 3);
...
(3, ' Kaktus mini Astrophytum', 'Kaktus mini jenis Astrophytum ini bentuknya menyerupai bintang atau buah belimbing. Bunganya ada yang berwarna kuning, merah, dan pink. Bagian batangnya membentuk seperti bola. Kaktus mini jenis ini termasuk yang cukup mudah berbunga. Untuk memancing pert', 'Kaktus_mini_Astrophytum.jpg', 'men', 'real', 'chuck taylor all star', 'black', 15000, 0, '2018-05-23 08:18:07', NULL, 3, 3),
(4, 'Kaktus Hias', 'Kaktus Hias', 'cactus2.JPG', 'men', 'real', 'chuck taylor all star', 'black', 30000, 0, '2018-05-23 08:52:43', NULL, 3, 3),
(7, 'Kaktus mini Ariocarpus', 'Pada umumnya, kaktus memiliki duri pada daunnya. Namun, kaktus hias jenis Ariocarpus ini justru tidak memiliki duri sama sekali. Daun kaktus mini ini memiliki bentuk prisma. Ada yang ujungnya melengkung, tumpul, atau runcing. Bunganya berukuran besar hamp', 'Kaktus_mini_Astrophytum1.jpg', 'men', 'real', 'chuck taylor all star', 'navy', 20000, 10, '2018-07-03 11:08:54', 3, 3, NULL),
(8, 'Chuck Taylor All Star', 'These lace-up Converse CT Ox Trainers have a textile with a geometric pattern. Converse branding is found on the heel & tongue. The toe shell and sole are white with black stripe detail. The brown waffle tread is deep for excellent grip.', 'ChuckTaylorAllStargrey1.JPG', 'men', 'sneaker', 'chuck taylor all star', 'grey', 659000, 0, '2018-07-03 11:10:58', 3, 3, 3),
(9, 'Chuck Taylor All Star Lift', 'This summer is all about living carefree in the Chuck Taylor All Star Lift. The canvas upper features fresh new colors, perfect for celebrating the season and your bold style. The stack sole elevates any look while the EVA insole for cushioning adds even ', 'ChuckTaylorAllStarLiftpink1.JPG', 'women', 'sneaker', 'chuck taylor all star', 'pink', 699000, 0, '2018-07-03 11:14:35', 3, 3, 3),
(10, 'One Star', 'Inspired by countries from all over the world, this collection of One Star sneakers is all about coming together in celebration. Each unique sneaker features a canvas upper with suede eyerow details, an EVA insole for cushioning, and our embroidered One S', 'OneStarblack1.JPG', 'men', 'sneaker', 'converse cons', 'black', 799000, 0, '2018-07-03 11:22:52', 3, NULL, 3),
(11, 'Kaktus mini Echinofossulocactus', 'Kaktus mini yang satu ini terlihat unik karena batangnya yang berwarna hijau tua dikelilingi dengan duri yang cukup besar. Kaktus mini Echinofossulocactus ini termasuk kaktus yang pertumbuhannya lambat. Ia membutuhkan waktu sekitar 3 tahun untuk mengeluar', 'cactus51.jpg', 'men', 'real', 'converse cons', 'navy', 15000, 0, '2018-07-03 11:25:45', 3, 3, NULL),
(12, 'Chuck Taylor All Star Dainty', 'This slim line classic Dainty Ox is a must for all wardrobes. With its simple thinner sole and slimmer look it works with all outfits and looks.', 'ChuckTaylorAllStarDaintypink1.JPG', 'women', 'sneaker', 'chuck taylor all star', 'blue', 559000, 0, '2018-07-03 11:30:36', 3, NULL, 3),
(13, 'Star Chevron Tri Color Tee', 'Tees, None', 'StarChevronTriColorTeeblue1.JPG', 'men', 'clothing', 'chuck taylor all star', 'blue', 259000, 0, '2018-07-04 08:32:55', 3, NULL, 3),
(14, 'Star Chevron Tri Color Tee', 'Tees, None', 'StarChevronTriColorTeeblack1.JPG', 'men', 'clothing', 'chuck taylor all star', 'black', 259000, 0, '2018-07-04 08:35:13', 3, NULL, 3),
(15, 'Graphic Boxstar PO Hoodie', 'Hoodie, None', 'GraphicBoxstarPOHoodieblue1.JPG', 'women', 'clothing', 'chuck taylor all star', 'blue', 559000, 0, '2018-07-04 08:37:04', 3, NULL, 3),
(16, 'Graphic Boxstar PO Hoodie', 'Hoodie, None', 'GraphicBoxstarPOHoodieblack1.JPG', 'women', 'clothing', 'chuck taylor all star', 'black', 559000, 0, '2018-07-04 08:39:07', 3, NULL, 3),
(17, 'One Star 2V', 'Cushioning: Sponge Rubber Lining: Textile Closure: Hook and Loop Closure', 'OneStar2Vred1.JPG', 'kids', 'sneaker', 'converse cons', 'red', 359000, 0, '2018-07-04 08:41:53', 3, 3, 3),
(18, 'Poly Chuck Plus Backpack', 'An affordable backpack for your laptop and all of your gear. Designed for comfort, this backpack has a place for everything. The front section provides a big zipped pocket for convenient storage. Two side pockets for water bottle/small accessories', 'PolyChuckPlusBackpack1.JPG', 'women', 'sneaker', 'converse cons', 'orange', 539100, 0, '2018-07-04 08:48:30', 3, NULL, 3),
(19, 'Women\'s Chuck Seasonal Camo Print Backpack', 'An affordable backpack for your laptop and all of your gear. Designed for comfort, this backpack has a place for everything. The front section provides a big zipped pocket for convenient storage. Two side pockets for water bottle/small accessories', 'WomensChuckSeasonalCamoPrintBackpack1.JPG', 'women', 'accessories', 'chuck taylor all star', 'pink', 539100, 0, '2018-07-04 08:50:43', 3, NULL, 3),
(21, 'Kaktus mini Cereus tetragonus', 'Kaktus mini berikutnya yang bisa kamu pelihara di rumah adalah kaktus mini jenis Cereus tetragonous. Kaktus mini ini berasal dari Amerika dan bisa tumbuh tinggi. Bentuknya menyerupai kastil sehingga cocok diletakkan di sekitar pagar rumah atau penghias je', 'kkatus_panjang1.jpg', '', 'real', '', '', 20000, 0, '2019-12-09 15:14:06', 3, 3, NULL),
(22, 'Kaktus mini Echinofossulocactus', 'kaktus panjang', 'cactus31.jpg', '', 'real', '', '', 10000, 0, '2019-12-09 17:36:45', 3, NULL, NULL);
...
(7, '37', 3, '2018-07-08 15:31:17', 3, NULL),
