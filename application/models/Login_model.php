...
class Login_model extends CI_Model {
	...
	{
		$this->db->select('id,nama,username,level,datecreated');
	...
	{
		$this->db->select('id,nama,username,datecreated');
		$this->db->from("owner");
		$this->db->where('username',$username);
		$this->db->where('password',$password);
		$query = $this->db->get();
	...
	{
		$this->db->select('id,nama,username,image,status,status_comment,datecreated');
